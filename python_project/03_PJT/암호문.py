...
for a in range(1,11):
    ...
    ten_num = f_nums # 10개만 따로 저장 예정 이거 기준으로 업데이트 해야한다
    ...
    for i in range(1,len(comm)): # 0번째를 빼고 실행하면댐 -1 ㄴㄴ
        # comm[i] : 1 5 400905 139831 966064 336948 119288 이게 처음값 공백을 없애야함
